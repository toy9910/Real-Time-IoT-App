...
import com.example.dbwithfragment.databinding.ActivityDustGraphBinding
import com.example.dbwithfragment.databinding.ActivityTempGraphBinding
...
class DustGraphActivity : AppCompatActivity() {
    ...
    val TAG = "joljak"
    lateinit var binding : ActivityDustGraphBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDustGraphBinding.inflate(layoutInflater)
        ...
        task.execute("http://" + IP_ADDRESS + "/dust_graph_getjson.php",cur_date_start,cur_date_end,day1_start,day1_end
    ...
    inner class GetGasAvgData : AsyncTask<String, Void, String>() {
        ...
        override fun onPostExecute(result: String?) {
            ...
            if(result == null)
                ...
                val lineDataset = LineDataSet(dataVals, "가스")
                lineDataset.setCircleColor(Color.GREEN)
                lineDataset.circleRadius = 4f
                lineDataset.lineWidth = 1.5f
                lineDataset.color = Color.GREEN
                ...
                data.setValueTextSize(10f)
                gasChart.data = data
                val customValueFormatter: CustomValueFormatter = CustomValueFormatter(gasChart)
                gasChart.xAxis.setValueFormatter(customValueFormatter)


                val xAxis = gasChart.xAxis
                xAxis.apply {
                    position = XAxis.XAxisPosition.BOTTOM
                    textSize = 12f
                    setDrawGridLines(false)
